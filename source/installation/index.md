...
3. 在以下网址下载所需的CUDA,这里推荐12.2版本.[https://developer.nvidia.com/cuda-gpus](https://developer.nvidia.com/cuda-12-2-0-download-archive).注意需要根据上述输出选择正确版本
   ...
   ![image-20240610221819901](source/installation/assets/image-20240610221819901.png)
   ...
   **注意**：在确定Cuda自带驱动版本与GPU是否兼容之前，建议取消Driver的安装。![image-20240610221924687](source/installation/assets/image-20240610221924687.png)	

1. 完成后输入`nvcc -V`检查是否出现对应的版本号，若出现则安装完成。![image-20240610221942403](source/installation/assets/image-20240610221942403.png)
...
2. 选择对应的版本下载并根据提示安装。![image-20240610222000379](source/installation/assets/image-20240610222000379.png)

3. 打开cmd输入`nvcc -V`，若出现类似内容则安装成功。![image-20240610222014623](source/installation/assets/image-20240610222014623.png)

​		否则，检查系统环境变量，保证CUDA被正确导入。			![image-20240610222021868](source/installation/assets/image-20240610222021868.png)
...
如果您能成功看到类似下面的界面，就说明安装成功了。![image-20240610222057439](source/installation/assets/image-20240610222057439.png)
